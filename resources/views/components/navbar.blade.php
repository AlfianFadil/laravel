            ...
            <div class="ml-10 flex items-baseline space-x-4">
             <x-nav-link href="/dashboard" :active=" request() -> is('dashboard')">Dashboard</x-nav-link>
              ...
              <a href="{{ url('profile') }}" 
               ...
               <a href="{{ url('student') }}" 
                 class="rounded-md px-3 py-2 text-sm font-medium 
                 {{ request()->is('student') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">
                 Student
              </a>

              <a href="{{ url('guardians') }}" 
                 class="rounded-md px-3 py-2 text-sm font-medium 
                 {{ request()->is('guardians') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">
                 Guardians
               </a>

                <a href="{{ url('classroom') }}" 
                  class="rounded-md px-3 py-2 text-sm font-medium 
                  {{ request()->is('classroom') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">
                  Classroom 
                </a>
                
                <a href="{{ url('teachers') }}" 
                  class="rounded-md px-3 py-2 text-sm font-medium 
                  {{ request()->is('teachers') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">
                  Teachers  
                </a>
                
                <a href=" url('subjects') " 
                  class="rounded-md px-3 py-2 text-sm font-medium 
                  {{ request()->is('subjects') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">
                  Subjects
                </a>
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <el-dropdown class="relative ml-3">
              <button class="relative flex max-w-xs items-center rounded-full 
                ...
                <img src="https://i.pinimg.com/736x/ee/ce/ba/eeceba0076f54334c6a3d7496db8681a.jpg" 
    ...
    <el-disclosure id="mobile-menu" hidden class="md:hidden [&:not([hidden])]:block">
      ...
      <div class="border-t border-white/10 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium text-white">molcy</div>
